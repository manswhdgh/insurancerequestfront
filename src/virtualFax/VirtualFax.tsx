    ...
    return(
        <Layout>
            <main className="container main_pd text-center">
                ...
                <div className="fs-4 mb-5"><span className="fw-bold fs-3 text-pink">보험사선택</span> - 청구서작성 - 병원서류첨부 - 전송</div>
                <div className="py-5">
                    <div className="fs-2 fw-bold text-start mb-2"><i className="bi bi-telephone me-2"></i>선택 하신 보험사는 <span
