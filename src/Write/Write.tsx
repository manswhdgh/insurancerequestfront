        ...
        <Layout>
            <main className="container main_pd text-center">
                ...
                <div className="py-5">
                    ...
                    <input id="insurer_name" name="insurer_name" className="form-control py-6 mb-4" type="text"
                           placeholder="진료 받으신분(피보험자) 성함을 입력해주세요."
                           />
                        <div className="d-flex align-items-center mb-4">
                            <input id="insurer_number_front" name="insurer_number_front" className="form-control py-6" type="tel" placeholder="주민등록번호 앞(6자리)"
                                   />
                                <div className="mx-4">-</div>
                                <input id="insurer_number_back" name="insurer_number_back" className="form-control py-6" type="tel"
                                       placeholder="주민등록번호 뒤(7자리)"
                                       />
                        </div>
                        <div className="d-flex align-items-center">
                            <input id="insurer_phone_first" name="insurer_phone_first" className="form-control py-6" type="tel" placeholder="010"
                                   />
                                <div className="mx-4">-</div>
                                <input id="insurer_phone_second" name="insurer_phone_second" className="form-control py-6" type="tel" placeholder="0000"
                                       />
                                    <div className="mx-4">-</div>
                                    <input id="insurer_phone_third" name="insurer_phone_third" className="form-control py-6" type="tel" placeholder="0000"
                                           />
                        </div>
                </div>
