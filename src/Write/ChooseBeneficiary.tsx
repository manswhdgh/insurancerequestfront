                    ...
                    <div className="d-flex mb-3">
                        <input type="radio" className="btn-check me-4" name="options-outlined" id="btn01"
                            ...
                            <label
                                ...
                                htmlFor="btn01" style={{height:"400px"}}><i className="bi bi-circle fs-0_5 mb-4"></i>피보험자(진료
                                받은 분)와<br/>수익자가
                                    동일</label>
                            ...
                            <input type="radio" className="btn-check me-4" name="options-outlined" id="btn02"
                                ...
                                <label
                                    ...
                                    htmlFor="btn02"><i className="bi bi-x-circle fs-0_5 mb-4"></i>피보험자(진료받은분)와<br/>수익자가
                                    다름</label>
                    </div>
                </div>
